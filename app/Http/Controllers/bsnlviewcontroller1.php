...
$users = DB::table('mobnum')->join('newservices', 'mobnum.service_id', '=', 'newservices.service_id')->select('number')->where('sim_type','=','prepaid')->where('num_type','=','fancy')->where('provider_name','=','bsnl')->where('sim_status','=','not selected')->get();
