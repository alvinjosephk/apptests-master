...
$users = DB::table('mobnum')->join('newservices', 'mobnum.service_id', '=', 'newservices.service_id')->select('number','price')->where('provider_name','=','idea')->where('sim_type','=','prepaid')->where('num_type','=','fancy')->where('sim_status','=','not selected')->get();
